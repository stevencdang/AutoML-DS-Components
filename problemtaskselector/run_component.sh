...
PYTHONPATH="$path" python src/main.py -programDir $cwd -workingDir $cwd/test/output -task_name "CLASSIFICATION" -file0=$cwd/test/datasetDoc.tsv -file1=$cwd/test/problemTarget.tsv -userId=' ' -is_test=1
