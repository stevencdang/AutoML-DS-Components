...
PYTHONPATH="$path" python src/main.py -programDir $cwd -workingDir $cwd/test/output -file0="$cwd/test/datasetDoc.json" -file1=$cwd/test/problemDoc.json -userId=' ' -is_test=1
