...
comp_dir_name="CompareModelScores"
...
echo -e "\t'Compare_Model_Scores'," >> $out_file
...
echo -e "\t'1.0', " >> $out_file
echo -e "\t'Generates an interactive html barplot comparing given model scores'" >> $out_file
echo -e ");" >> $out_file
