...
PYTHONPATH="$path" python src/main.py -programDir $cwd -workingDir $cwd/test/output -metric "ACCURACY" -file0=$cwd/test/datasetDoc.tsv -file1=$cwd/test/problemTask.tsv -userId=' ' -is_test=1
