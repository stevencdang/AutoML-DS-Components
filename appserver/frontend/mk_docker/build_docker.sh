...
if [ "$#" == 0 ]; then
    echo "No Options given. Building test image 'tigris.appserver.frontend:test' by default"
    name="registry.datadrivendiscovery.org/sdang/cmu-ta3/tigris.appserver.frontend:test"
else
    if [ "$1" == "test"]; then
