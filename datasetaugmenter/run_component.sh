...
PYTHONPATH="$path" python src/main.py -programDir $cwd -workingDir $cwd/test/output -userId=' ' -is_test=1 -file0="$cwd/test/datasetDoc.tsv"  -file1="$cwd/test/problemDoc.json" 
